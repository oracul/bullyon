...
// Copyright (c) 2013 bullyon Developers
...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // bullyon: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 4 * 60 * 60; // bullyon: every 4 hours
static const int64 nTargetSpacing = 60; // bullyon: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // bullyon: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bullyon miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bullyon", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("257ce9137f31a328efedca1118bd78ad7217f419449896cab21e090aad60b414");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Fat One Sleeps";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390357104;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2767507;
        ...
        assert(block.hashMerkleRoot == uint256("afca4da53db8d35697497c069bc6c6691fcea936aead93c18fd97ea4f9713ee5"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // bullyond: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
